  ...
  <div>
    ...
    <div class="mb-3">
        <Link class="group flex items-center py-3" href="/dashboard">
          ...
          <icon name="dashboard" class="mr-2 w-4 h-4" :class="isUrl('dashboard') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'" />
     ...
     <div class="mb-3">
        <div class="group flex items-center">
          <icon name="residentes" class="mr-1 w-4 h-4" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
          <button @click.stop="isOpen = !isOpen" :class="isUrl('') ? 'text-white' : 'text-cyan-300  w-full text-start group-hover:text-white'">Residentes</button>
          <icon name="plus" class="ml-auto w-2 h-2" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
        </div>
        <div v-show="isOpen">
     ...
     <div class="mb-3">
      <div class="group flex items-center">
        <icon name="empleados" class="mr-1 w-4 h-4" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
        <button @click.stop="isOpen2 = !isOpen2" :class="isUrl('') ? 'text-white' : 'text-cyan-300  w-full text-start group-hover:text-white'">Empleados</button>
        <icon name="plus" class="ml-auto w-2 h-2" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
      </div>
      <div v-if="isOpen2">
        <Link class="block pt-2 pl-2">Admin. Empleados</Link>
     ...
     <div class="mb-3">
      <div class="group flex items-center">
        <icon name="usuarios" class="mr-1 w-4 h-4" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
        <button @click.stop="isOpen3 = !isOpen3" :class="isUrl('') ? 'text-white' : 'text-cyan-300  w-full text-start group-hover:text-white'">Usuarios</button>
        <icon name="plus" class="ml-auto w-2 h-2" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
      </div>
      <div v-if="isOpen3">
     ...
     <div class="mb-3">
      <div class="group flex items-center">
        <icon name="finanzas" class="mr-1 w-4 h-4" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
        <button @click.stop="isOpen4 = !isOpen4" :class="isUrl('') ? 'text-white' : 'text-cyan-300  w-full text-start group-hover:text-white'">Finanzas</button>
        <icon name="plus" class="ml-auto w-2 h-2" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
      </div>
      <div v-if="isOpen4">
     ...
     <div class="mb-3">
      <div class="group flex items-center">
        <icon name="salud" class="mr-1 w-4 h-4" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
        <button @click.stop="isOpen5 = !isOpen5" :class="isUrl('') ? 'text-white' : 'text-cyan-300  w-full text-start group-hover:text-white'">Salud</button>
        <icon name="plus" class="ml-auto w-2 h-2" :class="isUrl('') ? 'fill-white' : 'fill-cyan-400 group-hover:fill-white'"/>
      </div>
