<template>
  <div>
    <div v-if="flashMessage && show" class="flex items-center justify-between my-3 max-w-4xl bg-green-500 rounded">
      <div class="flex items-center">
        ...
        <div class="py-4 text-white text-sm font-medium">{{ flashMessage }}</div>
      </div>
    ...
    <div v-if="error && show" class="flex items-center justify-between mb-8 max-w-3xl bg-red-500 rounded">
      <div class="flex items-center">
        ...
        <div v-if="error" class="py-4 text-white text-sm font-medium">{{ error }}</div>
      </div>
      <button type="button" class="group mr-2 p-2" @click="show = false">
