...
export default {
    ...
    setup(props) {
        ...
        const realizarMarcacion = (data) => {
            ...
            form.post(route('controlmed.store'), {
                forceFormData: true
            });
        ...
        return { titles, urlbase, realizarMarcacion }
                ...
                <tbody>
                    <tr v-for="horario in horarioMedicamentos" :key="horario.id" class="text-center shadow group">
                        <td v-for="residente in horario.medicamentos"
                            ...
                            <div> {{ residente.residente.persona.nombres }} {{ residente.residente.persona.apellidos }}</div>
                        </td>
                ...
                <div class="mb-3" v-for="horario in horarioMedicamentos" :key="horario.id">
                    ...
                    <div class="flex">
                        ...
                        <div class="contenido border  p-5 w-3/5">
                            <button
                                class="inline-block font-bold text-indigo-500 bg-indigo-200 py-2 px-3 border border-indigo-500 rounded-2xl hover:bg-indigo-400 hover:text-white ">Realizado</button>
                        </div>
                    </div>
                </div>
            </div>
