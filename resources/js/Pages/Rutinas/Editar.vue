...
export default {
    ...
    setup(props) {
        ...
        const form = useForm({
            ...
            residente_id: props.rutina.residente_id,
            horarios: props.rutinaHasHorarios
        });


        const agregarHorario = () => {
            form.horarios.push({ valor: '', hora: '' })
        }
        ...
        return { form, actualizar, agregarHorario, eliminarHorario, obtenerError };
    }
