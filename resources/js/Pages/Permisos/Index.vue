...
export default {
    ...
    setup(props) {
        ...
        return { eliminarPermiso, form, openModal, catchData, showModal, limpiarCampos, flashMessage, pillColor }
            ...
            <table
                ...
                <transition-group appear tag="tbody" name="list">
                    <tr class="text-center shadow group" v-for="permiso in permisos" :key="permiso.id"
                        ...
                        <td class="py-2 px-2 bg-white group-hover:bg-fondColor">
                            <span class="inline-block px-3 py-1 font-bold rounded-2xl capitalize"
                                :class="pillColor(permiso.estado_variacione.nombre_estado)">
